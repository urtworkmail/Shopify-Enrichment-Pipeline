# Supplier Scraping Assessment Report - SCRAPER v2
**Generated**: 2026-06-18

> **Client Summary**: We tested 51 suppliers. 11 are working (6,640 products), 22 need config work (9,302 products), 18 cannot be scraped (6,094 products). With fixes, we could reach ~80% coverage.
...
### Failure Categories by Status

#### no_config (16 suppliers)
**Cause**: No search URL template configured in SUPPLIER_SEARCH_CONFIG

**Affected Suppliers**: AH, PP, JS, AM, UM, SD, BT, IT, BA, BR, AB, LA, DU, CC, ST, BF

**Fix Required**: Add search URL template to scraper.py configuration

#### not_found (6 suppliers)
**Cause**: Supplier search returns no results for our products

**Affected Suppliers**: VC, WE, FM, JP, 3M, KC

**Possible Reasons**:
- Products not listed on supplier website
- Different product naming convention
- Products are discontinued

**Fix Options**:
1. Verify products actually exist on supplier site
2. Adjust search query format
3. Contact supplier for product availability

#### no_product_link (7 suppliers)
**Cause**: Search returns results but no clickable product link found

**Affected Suppliers**: BH, AP, CO, AR, GS, BX, PE

**Root Cause**: Site uses JavaScript/AJAX to load products OR search results are category pages

**Fix Required**: Update CSS selectors in SUPPLIER_SEARCH_CONFIG to find product links

#### verification_failed (7 suppliers)
**Cause**: Found a page but it doesn't match our target product

**Affected Suppliers**: EV, CS, ER, SL, RH, ZA, EC

**Root Cause**: Search returns category/landing pages, not specific product pages

**Fix Options**:
1. Adjust search query format
2. Add brand/vendor to search query
3. Add MPN to search for more specific results
4. Fine-tune verification threshold

#### multi_brand_no_match (2 suppliers)
**Cause**: Multi-brand supplier where specific brand not found in routing

**Affected Suppliers**: DS, GN

**Root Cause**: Brand router doesn't recognize the specific brand for this supplier

**Fix Required**: Update supplier_router.py to include specific brand mappings

#### scraped_empty (2 suppliers)
**Cause**: Page loaded successfully but content extraction returned empty

**Affected Suppliers**: KP, JH

**Root Cause**: Site uses JavaScript rendering OR custom HTML structure

**Fix Required**: Add site-specific CSS selectors to SUPPLIER_SEARCH_CONFIG

---

## Recommendations by Failure Type

| Failure Type | Suppliers | Recommended Action |
|-------------|-----------|-------------------|
| no_config | 8 | Add search URL templates to configuration |
| not_found | 5 | Verify products exist on supplier site |
| no_product_link | 8 | Update CSS selectors for product links |
| verification_failed | 6 | Adjust search queries or verification logic |
| multi_brand_no_match | 2 | Update brand routing |
| scraped_empty | 2 | Add site-specific selectors |
| connection_error | 1 | Retry or investigate connectivity |
...
```
[1/51] DS... MARGINAL - multi_brand_no_match
...
### DS - DS (distributor)
- **Domain**: www.canon.com.au
- **Products**: 3,634
- **Status**: multi_brand_no_match
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: DSTK-6119
- **Test Title**: Kyocera TK6119 Toner Cartridge Black 150

### FX - 
- **Domain**: rapidline.com.au
- **Products**: 2,795
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: FXD-ILLSWS5P1875 NW/WS
- **Test Title**: Rapidline Deluxe Infinity Single Sided 5

### EV - Educational Vantage
- **Domain**: www.teaching.com.au
- **Products**: 1,289
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: EVBBP2
- **Test Title**: Educational Colours Blackboard Paint 2L

### SR - 
- **Domain**: staedtler.com.au
- **Products**: 1,216
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: SR8010-749
- **Test Title**: Fimo Leather-Effect Rust

### AD - 
- **Domain**: www.averyproducts.com.au
- **Products**: 1,128
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: AD936070
- **Test Title**: Avery White Address and Shipping Inkjet 

### AH - 
- **Domain**: aerohealthcare.com
- **Products**: 1,117
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: AHIM13-SA07
- **Test Title**: Brayden Manikin Face Connection Adult

### PP - 
- **Domain**: pilotpen.com.au
- **Products**: 1,037
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: PP720147
- **Test Title**: Pilot FriXion Point Erasable Gel Pen Ult

### CS - Educational Vantage
- **Domain**: www.teaching.com.au
- **Products**: 1,006
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: CS0119
- **Test Title**: Candida DL Envelopes Window Face Secreti

### BH - 
- **Domain**: www.hamelinbrands.com.au
- **Products**: 800
- **Status**: no_product_link
- **Verdict**: MARGINAL
- **Reason**: Status: no_product_link
- **Test SKU**: BH10511
- **Test Title**: 3L 100852410 (10511) INDEX TABS 25MM WHI

### JS - 
- **Domain**: www.torkglobal.com
- **Products**: 769
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: JSSCL100ML
- **Test Title**: Deb Stokolan Classic Enriched Skin Condi

### GN - GN (wholesaler)
- **Domain**: www.collinsdebden.com.au
- **Products**: 703
- **Status**: multi_brand_no_match
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: GN46000
- **Test Title**: Livi 1301 Essentials Facial Tissue Hypoa

### AM - Australian Merchandiser (Osmer)
- **Domain**: www.velcro.com.au
- **Products**: 557
- **Status**: no_config
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: AMECB02
- **Test Title**: Osmer Elastic Chair Bag Navy Blue

### VC - 
- **Domain**: www.visionchart.com.au
- **Products**: 538
- **Status**: not_found
- **Verdict**: WONT WORK
- **Reason**: SKU search returns nothing
- **Test SKU**: VCEPBY-SKY
- **Test Title**: Creative Kids Book Tub 145 x 300 x 190mm

### TN - 
- **Domain**: www.thenotegroup.com.au
- **Products**: 518
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: TNNP4037
- **Test Title**: Writer Presentation Flipchart Pad 60gsm 

### UM - Uni / Mitsubishi Pencil
- **Domain**: uniball.com.au
- **Products**: 450
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: UMPC3M4PBWGS
- **Test Title**: Posca PC-3M Paint Marker Pen Bullet Fine

### WE - Weatherdon
- **Domain**: www.weatherdon.com.au
- **Products**: 445
- **Status**: not_found
- **Verdict**: WONT WORK
- **Reason**: SKU search returns nothing
- **Test SKU**: WE20711
- **Test Title**: Weatherdon Laundry Liquid 20ml Sachet Ca

### SD - Sanford / Newell Brands
- **Domain**: www.dymo.com.au
- **Products**: 418
- **Status**: no_config
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: SDS18007010
- **Test Title**: Papermate Flexgrip Ultra Ballpoint Pen M

### BT - 
- **Domain**: balatrading.com.au
- **Products**: 342
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: BT1195/70C
- **Test Title**: Bala Computer Paper Plain 70gsm 241 x 27

### FM - 
- **Domain**: www.fellowes.com
- **Products**: 335
- **Status**: not_found
- **Verdict**: WONT WORK
- **Reason**: SKU search returns nothing
- **Test SKU**: FM9540802
- **Test Title**: AeraMax Wall Mount Recess Kit for AM II 

### JP - Deflecto / Manhattan / Blueprint
- **Domain**: www.deflecto.com
- **Products**: 313
- **Status**: not_found
- **Verdict**: WONT WORK
- **Reason**: SKU search returns nothing
- **Test SKU**: JPMLS12
- **Test Title**: Deflecto 12 Pocket 3 Tier Brochure Holde
...
- **Reason**: Status: no_product_link
- **Test SKU**: AP188961
- **Test Title**: Mondi Colour Copy Paper 120gsm A4 210 x 

### 3M - 
- **Domain**: www.post-it.com
- **Products**: 269
- **Status**: not_found
- **Verdict**: WONT WORK
- **Reason**: SKU search returns nothing
- **Test SKU**: 3M98044054124
- **Test Title**: 3M Privacy Filter for 19" Widescreen Mon

### CO - 
- **Domain**: www.colby.com.au
- **Products**: 257
- **Status**: no_product_link
- **Verdict**: MARGINAL
- **Reason**: Status: no_product_link
- **Test SKU**: COKW-952-PACK
- **Test Title**: KW BY COLBY 2xCUTTER/4xDISC PACK KW-952

### PH - 
- **Domain**: www.phe.com.au
- **Products**: 222
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: PHMQUPANB989
- **Test Title**: PHE Qupa NB989 Electric Binding Punch Sy

### DO - 
- **Domain**: dolphy.com.au
- **Products**: 203
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: DODKTL0010
- **Test Title**: Dolphy 0.8L Stainless Steel Electric Ket

### IT - 
- **Domain**: www.italplast.com.au
- **Products**: 201
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: ITI 160NRD
- **Test Title**: Italplast Magazine Stand Neon Red

### KC - 
- **Domain**: www.kcprofessional.com
- **Products**: 146
- **Status**: not_found
- **Verdict**: WONT WORK
- **Reason**: SKU search returns nothing
- **Test SKU**: KC4735
- **Test Title**: Kleenex Toilet Tissue White 2 Ply 400 Sh
...
- **Reason**: Search finds products, selectors work
- **Test SKU**: ZN212
- **Test Title**: Zions Business Income and Expenditure Ca

### ER - Educational Vantage
- **Domain**: www.teaching.com.au
- **Products**: 89
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: ER5BBP
- **Test Title**: Elizabeth Richards Book Box Pack of 5 Pu
...
- **Reason**: Status: no_product_link
- **Test SKU**: ARB022
- **Test Title**: Arnos B022 Swingsign 5 Panel Expansion a
...
- **Reason**: Search finds products, selectors work
- **Test SKU**: CD10232
- **Test Title**: Collins 10232 Account Book Series A24 Mi

### BA - 
- **Domain**: corporate.bic.com
- **Products**: 52
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: BA10246.04
- **Test Title**: BIC Economy Ballpoint Pen Medium Black B

### SL - 
- **Domain**: www.brother.com.au
- **Products**: 41
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: SLQL-1100
- **Test Title**: Brother QL1100 Label Printer

### BR - 
- **Domain**: www.bouncerubberbands.com
- **Products**: 36
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: BRRETBAND018N
- **Test Title**: Bounce Rubber Bands Size 18 80 x 2.0mm 5

### GS - GS (wholesaler)
- **Domain**: spencil.com.au
- **Products**: 27
- **Status**: no_product_link
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: GSBCAYAR1
- **Test Title**: Spencil Yarrawala 1 A4 Book Cover Pack o
...
- **Reason**: Status: no_product_link
- **Test SKU**: BX2034-38
- **Test Title**: Bantex A4 Sheet Protectors Economy 35 Mi

### JA - 
- **Domain**: www.jasco.com.au
- **Products**: 25
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: JA0384304
- **Test Title**: Liquitex Acrylic Inks 316 Phthalocyanine

### FC - 
- **Domain**: www.faber-castell.com.au
- **Products**: 25
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: FC18-110072
- **Test Title**: Faber Castell Polychromos Colour Pencils

### AB - 
- **Domain**: www.abldistribution.com.au
- **Products**: 21
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: AB3542
- **Test Title**: 7 Rivers Compact Interleaved Towel 20x25

### LA - Lavazza
- **Domain**: twinings.com.au
- **Products**: 18
- **Status**: no_config
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: LA80013
- **Test Title**: Twinings Tea Chest 4 Compartment

### RH - Educational Vantage
- **Domain**: www.teaching.com.au
- **Products**: 18
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: RHWS171AS4
- **Test Title**: Nyda Airflow Softball Set of 4

### DU - Durasales
- **Domain**: www.durasales.com.au
- **Products**: 12
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: DUMN1604/72
- **Test Title**: Duracell MN1604 Coppertop Alkaline 9V Ba

### CC - Campbells Cash & Carry
- **Domain**: www.campbells.com.au
- **Products**: 11
- **Status**: no_config
- **Verdict**: MARGINAL
- **Reason**: Multi-brand - needs brand-specific routing
- **Test SKU**: CC967090
- **Test Title**: CADBURY CAFE BLEND DRINKING CHOCOLATE 1.

### PE - 
- **Domain**: www.pentel.com.au
- **Products**: 9
- **Status**: no_product_link
- **Verdict**: MARGINAL
- **Reason**: Status: no_product_link
- **Test SKU**: PEN50-D
- **Test Title**: Pentel N50 Permanent Marker Bullet Point

### ST - 
- **Domain**: www.stylustapes.com.au
- **Products**: 8
- **Status**: no_config
- **Verdict**: WONT WORK
- **Reason**: No search config configured
- **Test SKU**: ST0894
- **Test Title**: PP99 ACRYLIC PACKAGING TAPE CLEAR 48MMX7

### GG - 
- **Domain**: au.whogivesacrap.org
- **Products**: 4
- **Status**: success
- **Verdict**: WORKS
- **Reason**: Search finds products, selectors work
- **Test SKU**: GGWGACDL48
- **Test Title**: Who Gives a Crap Recycled Toilet Paper C

### ZA - Educational Vantage
- **Domain**: www.teaching.com.au
- **Products**: 4
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: ZAWP064
- **Test Title**: Creative School Supply Surfboard with St
...
- **Reason**: No search config configured
- **Test SKU**: BF371351
- **Test Title**: Bostik Blu Tack Multi Purpose Adhesive 7

### KP - 
- **Domain**: www.jshayes.com.au
- **Products**: 2
- **Status**: scraped_empty
- **Verdict**: MARGINAL
- **Reason**: Status: scraped_empty
- **Test SKU**: KP7230
- **Test Title**: Hamilton Active Family SPF50+ Sunscreen 

### EC - Educational Vantage
- **Domain**: www.teaching.com.au
- **Products**: 2
- **Status**: verification_failed
- **Verdict**: MARGINAL
- **Reason**: Status: verification_failed
- **Test SKU**: ECCS2JB2L
- **Test Title**: EC CLASSROOM SPLASH 2LT JELLY BELLY BLUE
...
- **Reason**: Status: scraped_empty
- **Test SKU**: JH0477829
- **Test Title**: Tork Black Cocktail Napkin Pack of 200 C
